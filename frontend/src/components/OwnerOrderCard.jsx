...
const calculateDeliveryFee = (amount) => {
    if (amount < 100) return 0;          // below minimum – no delivery
...
function OwnerOrderCard({ data }) {
    ...
    // ✅ Use shopOrder.subtotal to compute delivery fee
    ...
    return (
        <div
            className={`rounded-xl shadow-md p-5 mb-5 border transition-all duration-300 ${shopOrder?.status === "cancelled"
