      ...
      <div className="w-full max-w-[980px] flex flex-col gap-6 items-center mt-4">
        ...
        {currentOrder && (
          <div className="bg-white rounded-2xl p-5 shadow-md w-[92%] border border-orange-100 flex flex-col gap-4">
            ...
            {!showOtpBox ? (
              <button
                className="mt-4 w-full bg-green-500 text-white font-semibold py-3 px-4 rounded-xl shadow-md hover:bg-green-600 active:scale-95 transition-all duration-150 text-sm sm:text-base"
                onClick={sendOtp}
                disabled={loading}
              >
                {loading ? (
                  ...
                  `Mark As Delivered & Generate OTP`
                )}
              </button>
            ) : (
              <div className="mt-4 p-4 border border-orange-100 rounded-xl bg-orange-50/40">
                ...
                />
                {message && (
                  <p className="text-center text-green-500 text-sm mb-3">
                    {message}
                  </p>
                )}
                <button
                  className="w-full bg-[#ff4d2d] text-white py-2.5 rounded-lg font-semibold hover:bg-[#e64526] transition-all text-sm"
                  onClick={verifyOtp}
                >
